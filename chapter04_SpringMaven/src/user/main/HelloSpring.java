...
public class HelloSpring {
	public void menu(ApplicationContext context) {
		...
		while(true) {
			...
			if(num==1) userService = (UserService) context.getBean("userInsertService"); // 부모 = 자식 결합도가짱짱한 자기자신(UserInsertService) new 자기자신 하지않고 부모 = 자식으로 한다
	...
	public static void main(String[] args) {
		//spring의 applicationContext.xml 로 변경됨
